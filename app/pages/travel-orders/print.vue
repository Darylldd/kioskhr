...
.bg-top { position: absolute; top: -5.5px; left: -3px; width: 45%; max-height: 120px; object-fit: contain; object-position: top left; z-index: 1; }
.bg-bottom { position: absolute; bottom: -5.5px; right: -3px; width: 45%; max-height: 120px; object-fit: contain; object-position: bottom right; z-index: 1; }
