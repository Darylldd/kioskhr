...
.passlip-doc .top-left-banner { position: absolute; top: -6px; left: -3px; width: 50%; max-width: 400px; z-index: 1; }
.passlip-doc .bottom-right-banner { position: absolute; bottom: -6px; right: -3px; width: 50%; max-width: 400px; z-index: 1; }
