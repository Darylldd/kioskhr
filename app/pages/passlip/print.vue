      ...
      <div class="paper-content">
        ...
        <div class="header-section">
          ...
          <div class="header-text">
            ...
            <span class="agency-title">BUREAU OF FISHERIES AND AQUATIC RESOURCES</span><br />
...
.top-left-banner { position: absolute; top: -8px; left: 0; width: 50%; max-width: 400px; z-index: 1; }
.bottom-right-banner { position: absolute; bottom: -8px; right: 0; width: 50%; max-width: 400px; z-index: 1; }
...
.header-section { 
  ...
  align-items: center; 
  margin-bottom: 30px; 
  min-height: 90px; /* Gives the container enough height for the logos */
}
.logos { 
  position: absolute; 
  left: 0; 
...
@media print {
  ...
  .top-left-banner { position: fixed !important; top: -4px !important; left: -2px !important; }
  .bottom-right-banner { position: fixed !important; bottom: -4.5px !important; right: -3px !important; }
